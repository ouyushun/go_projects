...
// 	protoc        v5.27.3
// source: apps/userdd/rpc/userdd.proto
...
type GetUserInfoResp struct {
	...
	User *UserEntity `protobuf:"bytes,1,opt,name=userdd,proto3" json:"userdd,omitempty"`
}
...
type FindUserResp struct {
	...
	User []*UserEntity `protobuf:"bytes,1,rep,name=userdd,proto3" json:"userdd,omitempty"`
}
...
var file_apps_user_rpc_user_proto_goTypes = []any{
	(*UserEntity)(nil),      // 0: userdd.UserEntity
	(*Request)(nil),         // 1: userdd.Request
	(*Response)(nil),        // 2: userdd.Response
	(*LoginReq)(nil),        // 3: userdd.LoginReq
	(*LoginResp)(nil),       // 4: userdd.LoginResp
	(*RegisterReq)(nil),     // 5: userdd.RegisterReq
	(*RegisterResp)(nil),    // 6: userdd.RegisterResp
	(*GetUserInfoReq)(nil),  // 7: userdd.GetUserInfoReq
	(*GetUserInfoResp)(nil), // 8: userdd.GetUserInfoResp
	(*FindUserReq)(nil),     // 9: userdd.FindUserReq
	(*FindUserResp)(nil),    // 10: userdd.FindUserResp
}
var file_apps_user_rpc_user_proto_depIdxs = []int32{
	0,  // 0: userdd.GetUserInfoResp.userdd:type_name -> userdd.UserEntity
	0,  // 1: userdd.FindUserResp.userdd:type_name -> userdd.UserEntity
	1,  // 2: userdd.User.Ping:input_type -> userdd.Request
	3,  // 3: userdd.User.Login:input_type -> userdd.LoginReq
	5,  // 4: userdd.User.Register:input_type -> userdd.RegisterReq
	7,  // 5: userdd.User.GetUserInfo:input_type -> userdd.GetUserInfoReq
	9,  // 6: userdd.User.FindUser:input_type -> userdd.FindUserReq
	2,  // 7: userdd.User.Ping:output_type -> userdd.Response
	4,  // 8: userdd.User.Login:output_type -> userdd.LoginResp
	6,  // 9: userdd.User.Register:output_type -> userdd.RegisterResp
	8,  // 10: userdd.User.GetUserInfo:output_type -> userdd.GetUserInfoResp
	10, // 11: userdd.User.FindUser:output_type -> userdd.FindUserResp
